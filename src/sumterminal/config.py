...
class GeneralPreferences:
    ...
    font_small_caps_scale: float=0.65;
    font_uppercase_embolden: int=0;
    font_lowercase_embolden: int=0;
    show_tray: bool=True;
...
class TerminalPreferences:
    ...
    def normalized(self):
        ...
        self.general.font_small_caps_scale=max(0.50,min(0.85,float(self.general.font_small_caps_scale)));
        self.general.font_uppercase_embolden=max(0,min(3,int(self.general.font_uppercase_embolden)));
        self.general.font_lowercase_embolden=max(0,min(3,int(self.general.font_lowercase_embolden)));
        self.general.show_tray=bool(self.general.show_tray);
...
def _serialize(preferences):
    ...
    lines=["[general]","frontend = {}".format(_toml_value(value.general.frontend)),"shell = {}".format(_toml_value(value.general.shell)),"theme = {}".format(_toml_value(value.general.theme)),"font_name = {}".format(_toml_value(value.general.font_name)),"font_size = {}".format(_toml_value(value.general.font_size)),"font_bold = {}".format(_toml_value(value.general.font_bold)),"font_italic = {}".format(_toml_value(value.general.font_italic)),"font_small_caps = {}".format(_toml_value(value.general.font_small_caps)),"font_small_caps_scale = {}".format(_toml_value(value.general.font_small_caps_scale)),"font_uppercase_embolden = {}".format(_toml_value(value.general.font_uppercase_embolden)),"font_lowercase_embolden = {}".format(_toml_value(value.general.font_lowercase_embolden)),"show_tray = {}".format(_toml_value(value.general.show_tray)),"","[dropdown]","shortcut = {}".format(_toml_value(value.dropdown.shortcut)),"height = {}".format(_toml_value(value.dropdown.height)),"width = {}".format(_toml_value(value.dropdown.width)),"opacity = {}".format(_toml_value(value.dropdown.opacity)),"monitor = {}".format(_toml_value(value.dropdown.monitor)),"position = {}".format(_toml_value(value.dropdown.position)),"hide_on_focus_loss = {}".format(_toml_value(value.dropdown.hide_on_focus_loss)),"animation = {}".format(_toml_value(value.dropdown.animation)),""];
    return "\n".join(lines);
...
def load_preferences(path=None):
    ...
    for key in ("frontend","shell","theme","font_name","font_size","font_bold","font_italic","font_small_caps","font_small_caps_scale","font_uppercase_embolden","font_lowercase_embolden","show_tray"):
