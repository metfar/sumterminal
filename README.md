...
When a child application enables SGR mouse tracking, right-click is forwarded to that child; **Shift+right-click** forces the terminal's own context menu.  Without child mouse tracking, ordinary right-click opens the terminal menu.
...
## FontPicker preferences (0.1.0a18)
